...
class PluginsController(Controller):
    ...
    async def get_index(self, hub: NamedDependency[client.MeltanoHub]) -> api_schemas.PluginIndex:  # noqa: PLR6301
    ...
    async def stats(self, hub: NamedDependency[client.MeltanoHub]) -> dict[enums.PluginTypeEnum, int]:  # noqa: PLR6301
